...
import { flipSchema, incomeSchema, manualAdjustmentSchema, p2pWithdrawalSchema, savingsDepositSchema, workExpenseSchema } from "@/lib/schemas";
...
describe("schemas", () => {
  it("accepts comma decimals from mobile keyboards", () => {
    ...
    expect(workExpenseSchema.parse({ amount: "80,25", currency: "USDT", sourceAccountId: "wallet", incomeSourceId: "bots", transactionDate: "2026-07-05" }).amount).toBe(80.25);
  });
});
